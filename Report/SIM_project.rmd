...
## Impute with synthetic values
df2_test <- mice(df1_test, method = "cart")
...
predictions <- predict(mod1, newdata = df_model_test, type = "response")

# Evaluar las predicciones (ejemplo usando RMSE)
actual_values <- df_model_test$SalePrice  # Asegúrate de que 'SalePrice' está en tus datos de prueba
